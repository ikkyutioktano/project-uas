  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Warteg Ngonline </div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="navbar">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <a class="nav-link" href="<?php echo base_url('cetak/bukti') ?>">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <?php
                  $keranjang = 'Keranjang Pesanan : '.$this->cart->total_items().' Pesanan'
                  ?>

                  <?php echo anchor('dashboard/detail_pesanan', $keranjang ) ?>
                </li>
              </ul>
              <div class="topbar-divider d-none d-sm-block"></div>

            <ul class="na navbar-nav nav navbar-right">
